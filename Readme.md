# CardView for DataTables with styling for [Bulma](https://bulma.io/)

This is the distribution package for the [CardView extension](https://datatables.net/extensions/cardview) for [DataTables](https://datatables.net/) with styling for [Bulma](https://bulma.io/).
...
npm install datatables.net-cardview-bm
```
...
import 'datatables.net-cardview-bm'
